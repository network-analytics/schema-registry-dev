...
public class KafkaYangCborSchemaSerializerConfig extends AbstractKafkaSchemaSerDeConfig {
  ...
  public static final String YANG_CBOR_FAIL_UNKNOWN_PROPERTIES_DOC = "Whether to fail serialization"
      + " if unknown YANG-CBOR properties are encountered";
  ...
  public static final String YANG_CBOR_FAIL_INVALID_SCHEMA_DOC = "Whether to fail serialization if"
      + " the YANG-CBOR payload does not match the schema";
